...
export default function SpacePage(){
  ...
  return <div className="page">
    ...
    <div className="space-detail-grid"><section>
      <div className="quick-add"><input value={text} onChange={e=>setText(e.target.value)} onKeyDown={e=>{if(e.key==='Enter'&&canAdd)void add()}} placeholder="Add milk, take trash out, remind us…"/><button className="primary-button square" onClick={add} disabled={!text.trim()||!canAdd}><Plus/></button></div>
