...
export const APP_VERSION = runtime.appVersion || metaEnv.VITE_APP_VERSION || '2.1.0'
...
export const NATIVE_IOS = Boolean((window as any).__JUSTGLANCE_NATIVE__?.platform === 'ios')
