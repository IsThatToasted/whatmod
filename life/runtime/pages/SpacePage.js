...
import { ArrowLeft, CalendarDays, CheckCircle2, Copy, FolderKanban, Link2, ListPlus, Plus, ShieldCheck, ShoppingBasket, StickyNote, UserCog, UserPlus, Users } from 'lucide-react';
...
export default function SpacePage() {
    ...
    const lists = shoppingLists.filter(list => list.space_id === id && !list.archived_at);
