...
import { matchesMoodFocus, rankItems } from '../lib/relevance.js';
...
export default function NowPage() {
    ...
    return _jsxs("div", { className: "page now-page", children: [_jsxs("section", { className: "now-hero", children: [_jsxs("div", { className: "eyebrow-row", children: [_jsx("span", { children: formatDate(now) }), currentPlaceName && _jsxs("span", { className: "location-pill", children: ["Near ", currentPlaceName] })] }), _jsxs("h1", { children: [greeting(period), ", ", profile?.greeting_name || profile?.display_name || 'there', "."] }), _jsx("p", { className: "hero-line", children: hero })] }), featureFlags.MORNING_BRIEF && morning && _jsx(MorningBrief, {}), _jsx(MoodSelector, { value: mood, onChange: setMood }), _jsxs("section", { className: "now-grid", children: [_jsxs("div", { className: "feed", children: [_jsxs("div", { className: "section-heading", children: [_jsxs("div", { children: [_jsx("span", { className: "eyebrow", children: "WORTH DOING NOW" }), _jsx("h2", { children: useful.length ? (mood ? moodHeading[mood] : 'Useful right now') : 'You’re clear' })] }), _jsx(Sparkles, { size: 20 })] }), useful.length ? useful.map(scored => _jsxs("div", { className: "recommendation", children: [_jsx(ItemCard, { item: scored.item }), Boolean(import.meta.env?.DEV) && _jsxs("small", { className: "score-debug", children: ["score ", scored.score, " \u00B7 ", scored.reasons.slice(0, 2).join(', ')] })] }, scored.item.id)) : _jsxs("div", { className: "empty-card", children: [_jsx(CheckCircle2, {}), _jsx("strong", { children: "Nothing urgent." }), _jsx("span", { children: "Enjoy the open space, or capture something if it\u2019s on your mind." })] }), evening && featureFlags.DAILY_RESET && _jsx(DailyReset, {})] }), _jsxs("aside", { className: "context-panel", children: [_jsxs("div", { className: "context-card", children: [_jsxs("div", { className: "context-title", children: [_jsx(Clock3, { size: 18 }), _jsx("strong", { children: "Up next" })] }), next ? _jsxs(_Fragment, { children: [_jsx("h3", { children: next.title }), _jsxs("p", { children: [formatTime(next.start_time), next.location ? ` · ${next.location}` : ''] })] }) : _jsxs(_Fragment, { children: [_jsx("h3", { children: "Open runway" }), _jsx("p", { children: "No more scheduled events today." })] })] }), _jsxs("div", { className: "context-card", children: [_jsxs("div", { className: "context-title", children: [_jsx(Inbox, { size: 18 }), _jsx("strong", { children: "Inbox" })] }), _jsx("p", { children: inboxCount ? `${inboxCount} captured thing${inboxCount === 1 ? '' : 's'} to organize when you have a minute.` : 'Nothing waiting to be sorted.' })] }), _jsxs("div", { className: "context-card", children: [_jsxs("div", { className: "context-title", children: [_jsx(FolderKanban, { size: 18 }), _jsx("strong", { children: "Projects" })] }), _jsx("p", { children: activeProjects ? `${activeProjects} active project${activeProjects === 1 ? '' : 's'} with connected next actions.` : 'No active projects right now.' })] }), nextReminder && _jsxs("div", { className: "context-card", children: [_jsxs("div", { className: "context-title", children: [_jsx(BellRing, { size: 18 }), _jsx("strong", { children: "Reminder" })] }), _jsx("h3", { children: nextReminder.title }), _jsx("p", { children: new Date(nextReminder.remind_at).toLocaleString(undefined, { weekday: 'short', hour: 'numeric', minute: '2-digit' }) })] }), _jsxs("div", { className: "context-card", children: [_jsxs("div", { className: "context-title", children: [_jsx(Home, { size: 18 }), _jsx("strong", { children: "Shared" })] }), _jsxs("p", { children: [items.filter(i => i.space_id && i.status === 'open').length, " shared item(s) waiting."] })] }), preferences?.shared_activity_enabled !== false && activity[0] && _jsxs("div", { className: "context-card", children: [_jsxs("div", { className: "context-title", children: [_jsx(Users, { size: 18 }), _jsx("strong", { children: "Recent" })] }), _jsxs("p", { children: [activity[0].actor_name || 'Someone', " ", activity[0].action, " ", activity[0].entity_title, "."] })] }), _jsxs("div", { className: "context-card", children: [_jsxs("div", { className: "context-title", children: [_jsx(ShoppingBasket, { size: 18 }), _jsx("strong", { children: "Shopping" })] }), _jsxs("p", { children: [items.filter(i => i.type === 'shopping' && i.status === 'open').length, " item(s) on your lists."] })] }), _jsxs("div", { className: "context-card", children: [_jsxs("div", { className: "context-title", children: [_jsx(CheckCircle2, { size: 18 }), _jsx("strong", { children: "Today" })] }), _jsxs("p", { children: [completed, " completed so far."] })] })] })] })] });
}
