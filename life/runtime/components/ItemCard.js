...
export function ItemCard({ item, compact = false, readOnly }) {
    ...
    return _jsxs(_Fragment, { children: [_jsxs("article", { className: `item-card ${compact ? 'compact' : ''} ${item.shopping?.image_url ? 'has-product-image' : ''}`, children: [canEdit ? _jsx("button", { className: "complete-button", onClick: () => completeItem(item.id), "aria-label": `Complete ${item.title}`, children: _jsx(Check, { size: 18 }) }) : _jsx("span", { className: "complete-button readonly-complete", "aria-hidden": "true", children: _jsx(Check, { size: 18 }) }), item.type === 'shopping' && item.shopping?.image_url && _jsx("a", { className: "item-product-thumb", href: itemLink || item.shopping.image_url, target: "_blank", rel: "noreferrer", onClick: e => e.stopPropagation(), children: _jsx("img", { src: item.shopping.image_url, alt: "", referrerPolicy: "no-referrer" }) }), _jsxs("div", { className: "item-main", children: [_jsxs("div", { className: "item-title-row", children: [_jsx("strong", { children: item.title }), itemLink && _jsx("a", { className: "item-product-link", href: itemLink, target: "_blank", rel: "noreferrer", "aria-label": "Open attached link", onClick: e => e.stopPropagation(), children: _jsx(ExternalLink, { size: 14 }) }), item.priority === 'high' && _jsx("span", { className: "priority-dot", title: "High priority" })] }), _jsxs("div", { className: "item-meta", children: [due && _jsx("span", { children: due }), item.estimated_minutes && _jsxs("span", { children: [_jsx(Clock3, { size: 13 }), item.estimated_minutes, " min"] }), contextName && _jsx("span", { children: contextName }), currentSpace && _jsx("span", { children: currentSpace.name }), currentProject && _jsx("span", { children: currentProject.name }), item.waiting_for && _jsxs("span", { children: ["Waiting for ", item.waiting_for] }), assignee && _jsxs("span", { children: ["For ", assignee.greeting_name || assignee.display_name] }), contact && _jsxs("span", { children: [_jsx(UserRound, { size: 13 }), contact.display_name] }), item.recurrence_rule && _jsxs("span", { children: ["Repeats ", formatRecurrence(item.recurrence_rule)] }), item.type === 'shopping' && item.shopping?.quantity != null && _jsxs("span", { children: [item.shopping.quantity, item.shopping.unit ? ` ${item.shopping.unit}` : ''] }), item.type === 'shopping' && item.shopping?.preferred_store && _jsx("span", { children: item.shopping.preferred_store }), item.type === 'shopping' && item.shopping?.estimated_price != null && _jsx("span", { children: formatPrice(item.shopping.estimated_price, item.shopping.currency) }), contactPhone && _jsxs("a", { className: "item-dial-link", href: dialHref(contactPhone), onClick: e => e.stopPropagation(), children: [_jsx(Phone, { size: 13 }), "Dial ", contact?.display_name] }), itemLink && _jsxs("a", { className: "item-open-link", href: itemLink, target: "_blank", rel: "noreferrer", onClick: e => e.stopPropagation(), children: [_jsx(ExternalLink, { size: 13 }), "Open link"] })] })] }), canEdit && _jsxs("div", { className: "item-actions", children: [_jsx("button", { className: "icon-button", onClick: () => setMenu(value => !value), "aria-label": "Item actions", children: _jsx(MoreHorizontal, { size: 19 }) }), menu && _jsxs("div", { className: "popover", children: [_jsxs("button", { onClick: () => { setEditing(true); setMenu(false); }, children: [_jsx(Edit3, { size: 15 }), "Edit"] }), _jsxs("button", { onClick: () => { void updateItem(item.id, { due_date: addDaysISO(1), snoozed_until: null }); setMenu(false); }, children: [_jsx(CalendarPlus, { size: 15 }), "Move to tomorrow"] }), _jsxs("button", { onClick: () => { void snoozeItem(item.id); setMenu(false); }, children: [_jsx(RotateCcw, { size: 15 }), "Snooze 1 day"] }), _jsxs("button", { onClick: () => { void deleteItem(item.id); setMenu(false); }, children: [_jsx(Trash2, { size: 15 }), "Delete"] })] })] })] }), _jsx(Modal, { open: editing && canEdit, onClose: () => setEditing(false), title: "Edit item", children: _jsxs("div", { className: "form-stack", children: [_jsxs("label", { children: ["Title", _jsx("input", { value: title, onChange: e => setTitle(e.target.value) })] }), _jsxs("label", { children: ["Notes", _jsx("textarea", { value: description, onChange: e => setDescription(e.target.value), rows: 3 })] }), _jsxs("label", { children: ["Reference / product link", _jsx("input", { type: "url", inputMode: "url", value: sourceUrl, onChange: e => setSourceUrl(e.target.value), placeholder: "https://\u2026" })] }), _jsxs("div", { className: "two-col", children: [_jsxs("label", { children: ["Type", _jsxs("select", { value: type, onChange: e => setType(e.target.value), children: [_jsx("option", { value: "task", children: "Task" }), _jsx("option", { value: "shopping", children: "Shopping" }), _jsx("option", { value: "call", children: "Call" }), _jsx("option", { value: "errand", children: "Errand" }), _jsx("option", { value: "chore", children: "Chore" }), _jsx("option", { value: "reminder", children: "Reminder" }), _jsx("option", { value: "idea", children: "Idea" })] })] }), _jsxs("label", { children: ["Priority", _jsxs("select", { value: priority, onChange: e => setPriority(e.target.value), children: [_jsx("option", { value: "low", children: "Low" }), _jsx("option", { value: "normal", children: "Normal" }), _jsx("option", { value: "high", children: "High" })] })] })] }), _jsxs("div", { className: "two-col", children: [_jsxs("label", { children: ["Due date", _jsx("input", { type: "date", value: dueDate, onChange: e => setDueDate(e.target.value) })] }), _jsxs("label", { children: ["Due time", _jsx("input", { type: "time", value: dueTime, onChange: e => setDueTime(e.target.value) })] })] }), _jsxs("div", { className: "two-col", children: [_jsxs("label", { children: ["Expected minutes", _jsx("input", { type: "number", min: "1", max: "1440", value: duration, onChange: e => setDuration(e.target.value) })] }), _jsxs("label", { children: ["Place", _jsxs("select", { value: placeId, onChange: e => setPlaceId(e.target.value), children: [_jsx("option", { value: "", children: "None" }), places.map(place => _jsx("option", { value: place.id, children: place.name }, place.id))] })] })] }), _jsxs("div", { className: "two-col", children: [_jsxs("label", { children: ["Space", _jsxs("select", { value: spaceId, onChange: e => { setSpaceId(e.target.value); setAssignedTo(''); }, children: [_jsx("option", { value: "", children: "Personal" }), spaces.filter(space => !space.is_personal && space.name !== 'Personal').map(space => _jsx("option", { value: space.id, children: space.name }, space.id))] })] }), _jsxs("label", { children: ["Assigned to", _jsxs("select", { value: assignedTo, onChange: e => setAssignedTo(e.target.value), disabled: !spaceId, children: [_jsx("option", { value: "", children: "Anyone" }), availableMembers.map(member => _jsx("option", { value: member.user_id, children: member.greeting_name || member.display_name }, member.user_id))] })] })] }), _jsxs("div", { className: "two-col", children: [_jsxs("label", { children: ["Project", _jsxs("select", { value: projectId, onChange: e => setProjectId(e.target.value), children: [_jsx("option", { value: "", children: "None" }), projects.filter(project => project.status === 'active').map(project => _jsx("option", { value: project.id, children: project.name }, project.id))] })] }), _jsxs("label", { children: ["Energy", _jsxs("select", { value: energy, onChange: e => setEnergy(e.target.value), children: [_jsx("option", { value: "", children: "Any" }), _jsx("option", { value: "low", children: "Low" }), _jsx("option", { value: "medium", children: "Medium" }), _jsx("option", { value: "high", children: "High" })] })] })] }), _jsxs("label", { children: ["Contact", _jsxs("select", { value: contactId, onChange: e => setContactId(e.target.value), children: [_jsx("option", { value: "", children: "None" }), contacts.map(contact => _jsx("option", { value: contact.id, children: contact.display_name }, contact.id))] })] }), _jsxs("label", { children: ["Waiting for", _jsx("input", { value: waitingFor, onChange: e => setWaitingFor(e.target.value), placeholder: "Person, delivery, approval\u2026" })] }), _jsxs("label", { children: ["Recurrence", _jsxs("select", { value: recurrence, onChange: e => setRecurrence(e.target.value), children: [_jsx("option", { value: "", children: "Does not repeat" }), _jsx("option", { value: "daily", children: "Daily" }), _jsx("option", { value: "weekdays", children: "Weekdays" }), _jsx("option", { value: "weekdays:1,3,5", children: "Mon / Wed / Fri" }), _jsx("option", { value: "weekly", children: "Weekly" }), _jsx("option", { value: "biweekly", children: "Every 2 weeks" }), _jsx("option", { value: "monthly", children: "Monthly" }), _jsx("option", { value: "every:2", children: "Every 2 days" }), _jsx("option", { value: "every:3", children: "Every 3 days" }), _jsx("option", { value: "every:14", children: "Every 14 days" })] })] }), type === 'shopping' && _jsxs("div", { className: "shopping-edit-group", children: [_jsx("span", { className: "eyebrow", children: "SHOPPING DETAILS" }), _jsxs("div", { className: "two-col", children: [_jsxs("label", { children: ["Quantity", _jsx("input", { type: "number", min: "0", step: "0.01", value: quantity, onChange: e => setQuantity(e.target.value) })] }), _jsxs("label", { children: ["Unit", _jsx("input", { value: unit, onChange: e => setUnit(e.target.value), placeholder: "each, lb, pack\u2026" })] })] }), _jsxs("div", { className: "two-col", children: [_jsxs("label", { children: ["Preferred store", _jsx("input", { value: preferredStore, onChange: e => setPreferredStore(e.target.value), placeholder: "Walmart" })] }), _jsxs("label", { children: ["Estimated price", _jsx("input", { type: "number", min: "0", step: "0.01", value: estimatedPrice, onChange: e => setEstimatedPrice(e.target.value) })] })] }), _jsxs("label", { children: ["Category / aisle", _jsx("input", { value: aisleCategory, onChange: e => setAisleCategory(e.target.value), placeholder: "Pantry, household, produce\u2026" })] }), _jsxs("label", { children: ["Currency", _jsx("input", { value: currency, onChange: e => setCurrency(e.target.value.toUpperCase()), maxLength: 3 })] })] }), _jsx("button", { className: "primary-button", onClick: saveEdit, disabled: !title.trim(), children: "Save changes" })] }) })] });
}
...
function rewriteSourceUrl(source, nextUrl) {
