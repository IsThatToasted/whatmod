...
import { calculateRelevanceScore } from './relevance.js';
import { todayISO } from './time.js';
const base = { id: '1', user_id: 'u', title: 'Task', type: 'task', status: 'open', priority: 'normal', context_tags: [], created_at: new Date().toISOString(), updated_at: new Date().toISOString(), snooze_count: 0 };
const context = { now: new Date(), period: 'afternoon', mood: null, minutesUntilNextEvent: null };
describe('relevance', () => {
