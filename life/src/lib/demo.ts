import type { ActivityEntry, EventItem, LifeItem, Note, Place, Profile, Space, SpaceMember } from '../types'
...
export const demoItems: LifeItem[] = [
  { id:'d1', user_id:DEMO_USER_ID, title:'Call dentist', type:'call', status:'open', priority:'high', due_date:todayISO(), due_time:'16:00', estimated_minutes:5, context_tags:['call'], created_at:iso, updated_at:iso, snooze_count:2 },
  { id:'d2', user_id:DEMO_USER_ID, title:'Return package', type:'errand', status:'open', priority:'normal', due_date:addDaysISO(1), estimated_minutes:15, context_tags:['errand'], created_at:iso, updated_at:iso, snooze_count:1 },
  ...
  { id:'d5', user_id:DEMO_USER_ID, title:'Change air filter', type:'chore', status:'open', priority:'low', due_date:addDaysISO(4), estimated_minutes:10, recurrence_rule:'every:90', context_tags:['home'], created_at:iso, updated_at:iso, snooze_count:0 },
...
export const demoMembers: SpaceMember[] = [
