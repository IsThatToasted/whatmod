...
enum AFErrorCode: String, Sendable {
    ...
    case oauthSession = "AF-AUTH-101"
    case oauthRedirect = "AF-AUTH-102"
    case nativeAuthStart = "AF-AUTH-106"
    case nativeAuthCallbackMissing = "AF-AUTH-107"
    case nativeAuthSession = "AF-AUTH-108"
    case nativeGoogleConfig = "AF-AUTH-109"
    case nativeGooglePresentation = "AF-AUTH-110"
    case nativeGoogleToken = "AF-AUTH-111"
    case nativeGoogleExchange = "AF-AUTH-112"
